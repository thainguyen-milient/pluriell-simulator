...
router.get('/login', (req, res) => {
  ...
  return res.redirect(`${process.env.SSO_GATEWAY_URL}/auth/login?productId=${process.env.SSO_GATEWAY_PRODUCT_ID}&returnTo=${encodeURIComponent(returnTo)}`);
});

// Logout route
router.get('/logout', (req, res) => {
  // Clear Pluriell JWT token cookie
