/**
 * Enhanced Session Authentication Helper for Cross-Subdomain SSO
...
class SessionAuthHelper {
    ...
    redirectToLogin(returnUrl = window.location.href) {
        const loginUrl = `${this.ssoGatewayUrl}/auth/login?productId=pluriell&returnTo=${encodeURIComponent(returnUrl)}`;
...
console.log('Enhanced Session Auth Helper initialized for Pluriell');
